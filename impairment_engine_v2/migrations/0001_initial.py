# Generated by Django 5.1.1 on 2025-07-13 12:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gdp_value', models.DecimalField(decimal_places=2, default=Decimal('3.00'), max_digits=6)),
                ('gdp_coefficient', models.DecimalField(decimal_places=6, default=Decimal('0.05'), max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('accessor_key', models.CharField(help_text='Key to match with loan data fields', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lgd_percentage', models.DecimalField(decimal_places=2, help_text='Loss Given Default percentage (e.g., 40.23)', max_digits=7)),
                ('is_active', models.BooleanField(default=True)),
